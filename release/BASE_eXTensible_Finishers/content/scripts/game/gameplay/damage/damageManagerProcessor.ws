...
class W3DamageManagerProcessor extends CObject 
{
	...
	// modXTFinishers END
	{
		...
		*/
		if( actionContext.dismember.explosion || (attackAction && (attackAction.GetAttackName() == 'attack_explosion' || attackAction.HasForceExplosionDismemberment())) || (petard && petard.DismembersOnKill()) || (bolt && bolt.DismembersOnKill()) )
		// modXTFinishers END
		{
			isExplosion = true;
		}
		...
		if ( usedWound )
		{
			...
			*/
			...
			if( actionContext.dismember.explosion && (W3AardProjectile)action.causer )
			// modXTFinishers END
			{
