...
import class CGameplayEntity extends CPeristentEntity
{
	...
	import final function SetFocusModeVisibility( focusModeVisibility : EFocusModeVisibility, optional persistent : bool );
	...
	public function HasAbility(abilityName : name) : bool												{return GetCharacterStats().HasAbility(abilityName);}
	...
	function GetFocusModeSoundEffectName() : name
	{	
	...
	event OnFocusModeSound( enabled : bool )
	{
		if ( !IsAlive() )
		{
			enabled = false;
